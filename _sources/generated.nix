...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  gptel = {
    pname = "gptel";
    version = "6abda6f465c46216e37ba6aad8daa5fcd5761326";
    src = fetchgit {
      url = "https://github.com/karthink/gptel.git";
      rev = "6abda6f465c46216e37ba6aad8daa5fcd5761326";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-2M/1t6meF2Hw+M+RF1i5qFIS6y60qWpv5pHK6+NwCYk=";
    };
    date = "2025-06-05";
  };
  helmify = {
  ...
  sui = {
    pname = "sui";
    version = "mainnet-v1.49.2";
    src = fetchurl {
      url = "https://github.com/MystenLabs/sui/releases/download/mainnet-v1.49.2/sui-mainnet-v1.49.2-ubuntu-x86_64.tgz";
      sha256 = "sha256-VroXk9GYjOXcCuoPZImphhvhhlnmj9vORtaB2gR2DwI=";
    };
  };
}
