...
}:
{
  ...
  gptel = {
    pname = "gptel";
    version = "424c835bc46ed083088e82e2fcd48c2e1c34bacf";
    src = fetchgit {
      url = "https://github.com/karthink/gptel.git";
      rev = "424c835bc46ed083088e82e2fcd48c2e1c34bacf";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-Fh3vb1VHlteqszZWxbpSpamQC/C7PT5I4jU+zojqqk8=";
    };
    date = "2026-03-29";
  };
  hashtopolis-agent = {
  ...
  sub2api = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.1.105";
      fetchSubmodules = false;
      sha256 = "sha256-kuy3aAOgPP+9HLfm6tQ7S6KBFjY7l8A33Wenzhdujec=";
    };
  };
  sui = {
    pname = "sui";
