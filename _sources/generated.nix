...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }: {
  ...
  chatgpt-arcana = {
    ...
    version = "b2b8ea295caaa2df5e4bcfdce6c9c6597878f79a";
    src = fetchgit {
      url = "https://github.com/CarlQLange/chatgpt-arcana.el.git";
      rev = "b2b8ea295caaa2df5e4bcfdce6c9c6597878f79a";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-clIoH86y8RWg/3KVjwwfVTFU3V+6xTqLxtU9/994WI4=";
    };
    date = "2023-03-09";
  };
  chatgpt-wrapper = {
    pname = "chatgpt-wrapper";
    version = "f99ff4761e3e6b7dbaf4c8e4a843820196601432";
    src = fetchgit {
      url = "https://github.com/mmabrouk/chatgpt-wrapper.git";
      rev = "f99ff4761e3e6b7dbaf4c8e4a843820196601432";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-5Xr6y4p5YJl8qlqveTngkh2sDpNvzgBaI5GCdVBjBI8=";
    };
    date = "2023-03-09";
  };
  copilot = {
  ...
  gptcommit = {
    pname = "gptcommit";
    version = "be21c0e8929abcf2879d4dc8b50fc808e2461f16";
    src = fetchgit {
      url = "https://github.com/zurawiki/gptcommit.git";
      rev = "be21c0e8929abcf2879d4dc8b50fc808e2461f16";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-4zXAOEFWL0J6nnztUsrEerSqjds9C8hL9+1eOPJdpUU=";
    };
    date = "2023-03-06";
  };
  java-tron-full-node = {
    ...
    src = fetchurl {
      url =
        "https://github.com/tronprotocol/java-tron/releases/download/GreatVoyage-v4.7.1/FullNode.jar";
  ...
  java-tron-solidity-node = {
    ...
    src = fetchurl {
      url =
        "https://github.com/tronprotocol/java-tron/releases/download/GreatVoyage-v4.7.1/SolidityNode.jar";
  ...
  lsp-bridge = {
    pname = "lsp-bridge";
    version = "59fe5cf379fe278c3470530edb1ffce547332935";
    src = fetchgit {
      url = "https://github.com/manateelazycat/lsp-bridge.git";
      rev = "59fe5cf379fe278c3470530edb1ffce547332935";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-6MOvI8XCH6G+K23X4NTzCqmP4gF5owKBxb7z2mFQc+I=";
    };
    date = "2023-03-09";
  };
  magit-gitflow = {
  ...
  newsapi-python = {
    ...
    src = fetchurl {
      url =
        "https://pypi.io/packages/source/n/newsapi-python/newsapi-python-0.2.7.tar.gz";
  ...
  org-ai = {
    pname = "org-ai";
    version = "48775bf1a2dd31e81f0a275c5106395282e32ed9";
    src = fetchgit {
      url = "https://github.com/rksm/org-ai.git";
      rev = "48775bf1a2dd31e81f0a275c5106395282e32ed9";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-tQFukKTvpSXxDlu2tUOQ5IdKDLRs26GpfIQd4Ej14PM=";
    };
    date = "2023-03-08";
  };
  org-cv = {
  ...
  tiktoken = {
    pname = "tiktoken";
    version = "ec7c121e385bf1675312c6c33734de6b392890c4";
    src = fetchgit {
      url = "https://github.com/openai/tiktoken.git";
      rev = "ec7c121e385bf1675312c6c33734de6b392890c4";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-lv1mMSYlFbgsSSuBpwTfWHyRmmgeh8M+Do2WWS5j+Lg=";
    };
    date = "2023-03-02";
  };
  tron-deployment = {
