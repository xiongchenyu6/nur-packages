...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  sui = {
    pname = "sui";
    version = "testnet-v1.37.1";
    src = fetchurl {
      url = "https://github.com/MystenLabs/sui/releases/download/testnet-v1.37.1/sui-testnet-v1.37.1-ubuntu-x86_64.tgz";
      sha256 = "sha256-qbdVV/0iz1DWaR6TnygdrzelVAhmGcKEOSVylJaVvYU=";
    };
  };
  tron-deployment = {
