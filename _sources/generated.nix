...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  sui = {
    pname = "sui";
    version = "mainnet-v1.45.3";
    src = fetchurl {
      url = "https://github.com/MystenLabs/sui/releases/download/mainnet-v1.45.3/sui-mainnet-v1.45.3-ubuntu-x86_64.tgz";
      sha256 = "sha256-YB1DS8qVrkX5EzpEPxVgE7ubzP9N3EErNsJi6Gk7jO8=";
    };
  };
}
