...
, ruby_3_1, replace, gzip, gnutar, git, cacert, util-linux, gawk, nettools
...
, yarn, fixup_yarn_lock, nodePackages, nodejs-16_x

, plugins ? [ ] }@args:

let
  version = "3.1.0.taa2-hb";
  ...
  assets = stdenv.mkDerivation {
    ...
    patches = [
      ...
      ./0001-feat-add-itoken-footer.patch
    ];
    ...
    installPhase = ''
      ...
      cp ${
        ./itoken-resources/topics.hbs
      } app/assets/javascripts/discourse/app/templates/discovery/topics.hbs
  ...
  discourse = stdenv.mkDerivation {
    ...
    installPhase = ''
      ...
      mkdir -p $out/share
      cp ${./itoken-resources/wallet-logo.png} app/assets/images/wallet-logo.png
...
in discourse
# cp ${./itoken-resources/discord.svg} app/assets/images/discord.svg

# cp ${./itoken-resources/f-web.svg} app/assets/images/f-web.svg

# cp ${./itoken-resources/m-web.svg} app/assets/images/m-web.svg

# cp ${./itoken-resources/t-web.svg} app/assets/images/t-web.svg
