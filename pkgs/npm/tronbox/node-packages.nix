  ...
  sources = {
    ...
    "tronweb-4.4.0" = {
      ...
      src = fetchurl {
        ...
        sha512 = "0yPmjQE1drPcDtW4YCXFjtvDQmKc/utjKB2J6U5GDcWWhsGqE8yFjdIMJRa1yj1a/oFQNlthKMzw4Jd7lkWbYA==";
      };
    };
...
in
{
  tronbox = nodeEnv.buildNodePackage {
    ...
    src = fetchurl {
      ...
      sha512 = "niTrJZ3ipRWP8A1T7Gi47TQlOMrHX2LF6QDQiWROvE3s+iMVPtGoN6fKcJmj4ZdQLIyPANQxCdl5WhqJ71EU2A==";
    };
    dependencies = [
